document.addEventListener('DOMContentLoaded', () => {
  ...
  btnCarrinho && btnCarrinho.addEventListener('click', (e) => {
    // link já navega; mantido por segurança
  });

  // --- Tratamento do botão de três riscos com animação ---
  if (btnMenu && menuOpcoes) {
    btnMenu.addEventListener('click', (e) => {
      ...
      btnMenu.classList.toggle('open', !isVisible);
    });
  ...
  // --- Item "Sair" limpa localStorage e redireciona para login ---
  if (menuSair) {
